...
# cópia do jogo adaptado para rodar o treino, i.e, tiramos a parte gráfica
...
# lagura de algumas sprites para facilitar codificação
...
def main():
    ...
    # argumento para ecolher numero de iterações
    parser.add_argument("--iter", type=int, default=train_iterations, help="number of iterations to run")
    # argumento para escolher se gostaria de ver tudo
    parser.add_argument(
        "--verbose", action="store_true", help="mostra no terminal [iteration | score]"
    )
